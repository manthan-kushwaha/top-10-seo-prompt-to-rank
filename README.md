...
These prompts are designed not only to **save time** but also to align with Google’s **EEAT** (Experience, Expertise, Authoritativeness, Trustworthiness) and **AEO** (Answer Engine Optimization) standards.
...
**Why it matters:**  
An SEO audit is your **base layer**. Without fixing technical, content, and UX issues, even the best campaigns won’t rank. Prioritize high-impact fixes that align with **Google’s Core Web Vitals** and **EEAT signals**.
...
> **Prompt:** For the keyword ‘{KEYWORD}’, analyse search intent. Break it into primary and secondary user goals. Suggest ideal content format, page structure, and CTA strategy.

**Why it matters:**  
Ranking isn’t just about keywords — it’s about **matching intent**. This reduces bounce rates and keeps users engaged.

---

### 4. Programmatic SEO Template Generator  
> **Prompt:** Create a reusable SEO article template for ‘{KEYWORD FRAMEWORK}’, designed for programmatic generation. Include intro, modular blocks (tables, FAQs, lists), and recommended internal/external links.

**Why it matters:**  
Programmatic SEO helps **scale content creation** for product comparisons, location pages, or FAQs — vital for SaaS, marketplaces, and publishers.

---

### 5. Entity-Optimised Article Creator  
> **Prompt:** Write a long-form article for the keyword ‘{KEYWORD}'. Optimise for AI Overviews and semantic SEO. Include entities, subtopics, FAQs, and a concise summary answer at the top.
...
> **Prompt:** Build a topical map for the niche ‘{NICHE}’. Show the main pillar pages, cluster topics, and long-tail supporting articles needed to build topical authority.
...
> **Prompt:** Analyse the top 10 Google results for ‘{KEYWORD}'. Summarise shared features like structure, word count, format, visuals, and metadata. Then suggest how to differentiate and outperform.

**Why it matters:**  
Stop guessing. Competitor analysis shows gaps → **differentiate with design, CTAs, and insights**.

---

### 8. BOFU Content Finder  
> **Prompt:** Act as a B2B SEO strategist. For the product/service ‘{YOUR PRODUCT OR OFFER}’, list 15 BOFU keywords that signal strong purchase intent. Include variations like ‘best’, ‘vs’, ‘review’, ‘alternative’, ‘pricing’, ‘tool’, ‘agency’, and buyer pain points.

**Why it matters:**  
BOFU captures **ready-to-buy users** → directly increases **conversions & revenue**.

---

## 🔴 Level 4: Future-Focused SEO

### 9. LLM SEO  
> **Prompt:** Optimise this article {LINK} for LLM platforms like ChatGPT and Google AI Overviews. Ensure clear entity associations, direct answers, source credibility, and formatting that’s easy to extract as a summary.
...
### 10. Untapped Demand  
> **Prompt:** Act as an advanced SEO and product marketing strategist. For the audience {TARGET AUDIENCE} and product {YOUR PRODUCT}, list 20 ‘zero-volume’ or overlooked search queries that signal deep intent or pain. These should be phrased in natural language, question-based, or problem-first. Include use cases or scenarios.
...
## ✅ EEAT & AEO Integration Checklist
...
These 10 SEO prompts aren’t just **time-savers**; they’re **growth accelerators**.  
They help you:
...
**Next Step:** Choose **2–3 prompts today**, apply them to your site, and see the time saved.  
SEO isn’t about working harder — it’s about **working smarter**.
...
👉 **Connect with Manthan Kushwaha:** [LinkedIn](https://www.linkedin.com/in/manthan-kushwaha-50125718b/)  
